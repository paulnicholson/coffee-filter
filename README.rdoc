...
It was inspired by Ivan Nemytchenko's coffee-haml-filter but I wanted an installable gem and "coffee" as the filter name.
...
=== Caveats
Using Ruby interpolation within the +:coffee+ block will prevent Haml from caching the result of compilation.
